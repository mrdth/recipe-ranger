<x-app-layout>
    ...
    @if($recipe)
        <div id="the-recipe"
             class="container m-auto my-32 rounded shadow max-w-5xl bg-white overflow-hidden text-gray-800">
            <div class="py-6 px-8">
            ...
            <div>
                <div class="pb-6 px-8">
                    <h3 class="tracking-wider font-medium uppercase">Description</h3>
                    <div class="flex text-sm font-medium tracking-wide pt-3 pb-6 border-b border-gray-600">
                        {!! $recipe->description !!}
                    </div>
                </div>
            </div>
                            ...
                            <div class="text-md @if($row < 2) pr-4 @endif">
                                @foreach($ingredients as $ingredient)
                                    <div class="pb-2 text-sm flex items-center tracking-wide">
                                        <svg class="mr-2" style="min-width: 16px; max-width: 16px;" viewBox="0 0 24 24"
